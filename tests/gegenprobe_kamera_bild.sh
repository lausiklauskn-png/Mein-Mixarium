...
# ⚠ Und ein SPIEGEL-SCHRITT liegt dazwischen: die QC-Datei wird sabotiert,
#   dann `cp` auf index.html — diese App hat KEINEN Bau-Schritt, index.html ist
#   das byte-identische Spiegelbild. Ohne den Spiegel misst man die alte Datei,
#   und jeder Fall waere „nicht gefangen".
set -u
...
lauf(){ cp "$DATEI" index.html; node tests/smoke_kamera_bild.mjs 2>&1; }
