...
- **Offene Frage an Klaus (Netz-Form):** Soll der **Hub Sage** über eine **Zugehörigkeits-Achse**
  verbunden bleiben (unabhängig vom Themen-Cosinus), statt rein über das gleiche Thema? Bis dahin
  gilt ehrlich der Themen-Cosinus (< 0.80 = verified-spore).
