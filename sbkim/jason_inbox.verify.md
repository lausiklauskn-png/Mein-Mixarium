# Inbox-Vermerk — Jasons-Tresor (reziproke Spore-Pruefung)

> Gegenprobe der byte-1:1 uebernommenen Nachbar-Spore `sbkim/jason_inbox.json`.
...
| nodeType | hybrid |
| Quelle | `raw …/Jasons-Tresor/main/sbkim/spore.json` → byte-1:1 als `sbkim/jason_inbox.json` |
