...
- **Neuer Cosinus** unser NEUER domainVector (ausführliche Getränke-Beschreibung) ⟷ Mein-Tresor = **0.8193** ≥ 0.80. *Themenfremd (JSON-Tresor ≠ Getränke) — der Wert liegt nur durch den Prosa-Längeneffekt knapp über 0.80, KEIN echtes Themen-Match.*
